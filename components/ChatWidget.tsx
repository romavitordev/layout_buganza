              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {CATEGORIAS.map((c) => (
                  <button
                    ...
                    className="rounded-pill border border-black/15 bg-white px-3 py-1.5 text-[12px] font-medium text-secundario transition-colors hover:border-black hover:text-black"
                  >
                    {c}
                  </button>
                ))}
